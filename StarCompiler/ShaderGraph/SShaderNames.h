...
inline const char* getName(const DescriptorRegisterSpace& v) noexcept { return "DescriptorRegisterSpace"; }
...
inline const char* getName(const DescriptorValue& v) noexcept { return "DescriptorValue"; }
...
inline const char* getName(const LightSource_& v) noexcept { return "LightSource"; }
inline const char* getName(const CameraSource_& v) noexcept { return "CameraSource"; }
...
inline const char* getName(const RootParameter& v) noexcept { return "RootParameter"; }
