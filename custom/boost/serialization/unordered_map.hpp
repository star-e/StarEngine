...
inline void save(
    Archive & ar,
    const std::unordered_map<Key, Value, HashFcn, EqualKey, Allocator> &t,
    const unsigned int /*file_version*/
){
    boost::serialization::stl::save_unordered_collection<
        Archive, 
        std::unordered_map<Key, Value, HashFcn, EqualKey, Allocator>
    >(ar, t);
}
...
inline void load(
    Archive & ar,
    std::unordered_map<Key, Value, HashFcn, EqualKey, Allocator> &t,
    const unsigned int /*file_version*/
){
...
inline void save(
    ...
    boost::serialization::stl::save_unordered_collection<
        Archive, 
        std::unordered_multimap<Key, Value, HashFcn, EqualKey, Allocator>
    >(ar, t);
}
