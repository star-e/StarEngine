...
inline const char* getName(const Dynamic_& v) noexcept { return "Dynamic"; }
...
inline const char* getName(const double3_& v) noexcept { return "double3"; }
inline const char* getName(const double2_& v) noexcept { return "double2"; }
inline const char* getName(const double1_& v) noexcept { return "double1"; }
